...
const SECTIONS = [
  ...
  },
  {
    ...
    credits: [
      ...
      ["Day/Night Demo Cycle Keeper", staffAt(133)],
      ...
      ["PX-27 Android Rig Integrator", staffAt(153)],
      ["Enemy Navmesh Patrol Wrangler", staffAt(154)],
      ["Rifle Magazine & Reload Choreographer", staffAt(155)],
      ["Cover Seeking Behaviour Therapist", staffAt(156)],
      ["Grenade Death Knockback Animator", staffAt(157)],
  ...
  },
  {
    ...
    credits: [
      ...
      ["PX-27 Walk Cycle In-Place Lead", staffAt(158)],
      ["Abdominal Death Clip Curator", staffAt(159)],
      ["Enemy Rig Muzzle Offset Wizard", staffAt(160)],
  ...
  },
  {
    ...
    credits: [
      ...
      ["Bullet Hit Ouch Curator", staffAt(134)],
  ...
  {
    title: "Control Panel & Combat Polish",
    credits: [
      ["Control Panel Foot Z-Fight Therapist", staffAt(135)],
      ["Sharp Corner Extrusion Purist", staffAt(136)],
      ["Screen Quad Floor Alignment Lead", staffAt(137)],
      ["Plinth Hull Overlay Offset Engineer", staffAt(138)],
      ["Laser Tracer Visibility Lead", staffAt(139)],
      ["Muzzle-Aligned Hitscan Bolt Artist", staffAt(140)],
      ["Cinematic Glow Bolt Supervisor", staffAt(147)],
      ["Shop Denied Buzz Coordinator", staffAt(148)],
      ["North-Wall Purchase Ring Crosshair Lead", staffAt(149)],
      ["Hip Idle Weapon Breathe Animator", staffAt(150)],
      ["ADS Zoom & Strafe Tuning Lead", staffAt(151)],
      ["Weapon Blue Palette Enforcer", staffAt(141)],
      ["Line2 Screen-Space Width Advocate", staffAt(142)],
      ["Gameplay Hint Toast Architect", staffAt(143)],
      ["F-For-Flashlight Pulse Timer", staffAt(144)],
      ["Idle Press-N Hint Banisher", staffAt(145)],
      ["Door Prompt Pattern Copyist", staffAt(146)],
      ["Still Not Cyan Consultant", GOLD_STAFF[8]],
      ["Patch Notes Scribe", CARL],
    ],
  },
  {
    title: "Cast",
    credits: [
      ...
      ["PX-27 Combat Android", "Meshy AI · As Themselves"],
      ["The Gun", staffAt(90)],
  ...
  },
  {
    ...
    credits: [
      ...
      ["Meshy AI", "PX-27 android mesh and death animations"],
