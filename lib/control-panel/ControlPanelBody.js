...
export const CONTROL_PANEL_HULL_EMISSIVE_INTENSITY = 0.45;
const HULL_EMISSIVE_INTENSITY = CONTROL_PANEL_HULL_EMISSIVE_INTENSITY;
...
/**
 * [cap + extruded sides] both use hull maps + profile cap UVs (fillet bleed on base mesh).
