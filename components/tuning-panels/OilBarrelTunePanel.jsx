...
import { OIL_BARREL_TUNING_LIMITS as L } from "@/lib/oil-barrel/OilBarrelTuning";
import {
  PILE_HUB_POS_MAX,
  PILE_HUB_POS_MIN,
  PILE_HUB_POS_NUDGE,
...
/** @param {
 *   tuning: import("@/lib/oil-barrel/OilBarrelTuning").OilBarrelTuning,
 *   onChange: (
 *     key: keyof import("@/lib/oil-barrel/OilBarrelTuning").OilBarrelTuning,
