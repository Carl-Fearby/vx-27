...
export const CONSOLE_HACK_LAYOUT_KEY = "fps-console-hack-layout-v22";
...
export const HACK_ELEMENT_META = {
  ...
  statusPulse: { label: "Status pulse bars", group: "Left" },
  ...
  rewardIcon2: { label: "Ammo icon", group: "Right" },
  rewardLine2: { label: "+ 50 PISTOL AMMO", group: "Right" },
  rewardIcon3: { label: "Medkit icon", group: "Right" },
  rewardLine3: { label: "+ 1 MEDKIT", group: "Right" },
  footerMove: { label: "WASD MOVE", group: "Footer" },
  ...
  footerExit: { label: "ESC EXIT", group: "Footer" },
};
...
export const DEFAULT_CONSOLE_HACK_LAYOUT = {
  ...
  statusValue: line(0.038, 0.142, 0.184, 0.032, {
    labelColor: "#ffffff",
    fontScale: 0.85,
  }),
  ...
  timerLabel: line(0.038, 0.589, 0.12, 0.024, {
    labelColor: "#0099ff",
    fontScale: 1.15,
  }),
  ...
  gridStart: line(0.228, 0.375, 0.09, 0.034),
  ...
  secureChannelLabel: line(0.868, 0.214, 0.14, 0.024, { fontScale: 0.75 }),
  secureChannelLock: line(0.815, 0.202, 0.053, 0.07, {
    labelColor: "#0099ff",
    valueColor: "#00c3ff",
    fontScale: 0.65,
  }),
  secureChannelBars: line(0.868, 0.248, 0.081, 0.022, {
    labelColor: "#78c8ff",
    valueColor: "#9ee8ff",
    accentColor: "#b4ecff",
    fontScale: 1,
  ...
  rewardIcon1: line(0.812, 0.655, 0.05, 0.05, REWARD_ICON_COLORS),
  rewardLine1: line(0.856, 0.668, 0.14, 0.026, { fontScale: 0.85 }),
  rewardIcon2: line(0.812, 0.704, 0.05, 0.05, REWARD_ICON_COLORS),
  rewardLine2: line(0.856, 0.714, 0.14, 0.026, { fontScale: 0.85 }),
  rewardIcon3: line(0.812, 0.754, 0.05, 0.05, REWARD_ICON_COLORS),
  rewardLine3: line(0.856, 0.765, 0.14, 0.026, { fontScale: 0.85 }),
  footerMove: line(0.231, 0.847, 0.11, 0.03, { ...FOOTER_COLORS, fontScale: 1.05 }),
  footerRotate: line(0.37, 0.845, 0.11, 0.03, { ...FOOTER_COLORS, fontScale: 1.05 }),
  footerConfirm: line(0.503, 0.847, 0.11, 0.03, { ...FOOTER_COLORS, fontScale: 1.05 }),
  footerReset: line(0.621, 0.847, 0.11, 0.03, { ...FOOTER_COLORS, fontScale: 1.05 }),
  footerExit: line(0.714, 0.847, 0.11, 0.03, { ...FOOTER_COLORS, fontScale: 1.05 }),
};
