...
const _flashlightGroundDir = new THREE.Vector3();
    ...
    update(camera, aimTarget, dt, tuningRef, options = {}) {
      ...
      if (roundDisplay) {
        ...
        if (roundTuning?.hip && roundTuning?.aim) {
          const displayPose = roundDisplaySnapAim
            ? resolveSnappedRoundDisplayPose(
                roundTuning.hip,
                roundTuning.aim,
                aimBlend,
        ...
        const roundStamina =
          typeof options.roundDisplayStamina === "number"
            ...
            : 1;
        roundDisplay.setCount(
          roundCount,
          Boolean(options.roundDisplayLow),
          roundHp,
          roundStamina,
        );
      }
      ...
      if (weaponFlashlight) {
        ...
        weaponFlashlight.sync(_flashlightPos, _flashlightDir, flashlightActive, {
          ...
          groundDirection: _flashlightGroundDir,
