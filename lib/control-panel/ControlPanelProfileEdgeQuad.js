...
/** Pull hull/C/D quads slightly past the extruded side (avoids z-fight with grey strip). */
export const PROFILE_EDGE_FACE_OFFSET = 0.012;

/** Rear panel sits slightly past the extruded back strip. */
export const PROFILE_EDGE_BACK_FACE_OFFSET = 0.02;
