...
const FIRE_LIGHT_SHADOW_RADIUS_SOFT = 12;
const FIRE_LIGHT_SHADOW_RADIUS_CRISP = 6;
const FIRE_LIGHT_SHADOW_BLUR_SOFT = 32;
const FIRE_LIGHT_SHADOW_BLUR_CRISP = 18;
...
/** Key shadows always use room + world passes; fill stays world-only. */
...
/**
 * Toggle fire-light shadow maps (L+R per barrel can exceed texture unit budget).
 * @param {THREE.Object3D} root
