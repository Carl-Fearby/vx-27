...
/** @param {{ tuning: import("@/lib/player/WalkBobTuning").WalkBobSimpleTuning, onChange: (key: keyof import("@/lib/player/WalkBobTuning").WalkBobSimpleTuning, value: number) => void, onReset: () => void, onClose?: () => void }} props */
