 ...
 * reads as a dark line on the deck (x ≈ 4.8, z ≈ −12). From the arena floor,
 * visibility follows the camera frustum so the room floor draws whenever you
 * can see into the cut-out deck hole. Light layers follow the same rule as the
 * room pass whenever the camera sees interior geometry (see FpsGame frame loop).
 *
