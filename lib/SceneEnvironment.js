...
function nightLightStateFromDay(base, sheltered, light) {
  ...
  const fillMult = sheltered ? 0.025 : 0.06;
  const hemiMult = sheltered ? 0.08 : 0.14;
  const ambMult = sheltered ? 0.06 : 0.12;
...
/**
 * Barrel fire lights stay on WORLD + ROOM so open-top flames read in both passes.
