...
export const DEFAULT_VX27_CONTAINER_MATERIAL_TUNING = {
  exteriorBrightness: 1,
  exteriorRoughness: 1,
  exteriorMetalness: 1,
  interiorBrightness: 1,
  interiorRoughness: 1,
  interiorMetalness: 1,
  exteriorEmissiveIntensity: 2.4,
  interiorEmissiveIntensity: 2.4,
  normalScale: 1,
  endcapTextureScale: 1,
  cornerBevelUvRepeatU: 1,
  cornerBevelUvRepeatV: 1,
  cornerBevelBrightness: 1,
  cornerBevelRoughness: 1,
  cornerBevelMetalness: 1,
  doorTextureScale: 1,
...
export function loadVx27ContainerMaterialTuning() {
  ...
  try {
    ...
    return normalizeVx27ContainerMaterialTuning(JSON.parse(raw));
  } catch {
    return { ...DEFAULT_VX27_CONTAINER_MATERIAL_TUNING };
  }
}
...
export function saveVx27ContainerMaterialTuning(tuning) {
  ...
  localStorage.setItem(
    ...
    JSON.stringify(normalizeVx27ContainerMaterialTuning(tuning))
  );
}
