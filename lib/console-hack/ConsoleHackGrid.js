...
/** Per-node lightning + pulse CSS vars (shared by grid sprites and screen flash). */
export function hackLightningTimingStyle(index) {
  return {
...
/** ~10% of live nodes trigger a full-screen strobe on bolt strike. */
export function hackNodeScreenFlashEnabled(index, seed = 0) {
  return (index + seed) % 10 === 0;
}
