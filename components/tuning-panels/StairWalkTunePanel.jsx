...
/** @param {{ tuning: import("@/lib/stairs/StairWalkTuning").StairWalkTuning, onChange: (key: keyof import("@/lib/stairs/StairWalkTuning").StairWalkTuning, value: number) => void, onReset: () => void, onClose?: () => void }} props */
