...
export const RECOIL_TUNE_ENABLED_KEY = "fps-recoil-tune-enabled";
...
export function loadRecoilTuneEnabled() {
  if (typeof window === "undefined") return false;
  return localStorage.getItem(RECOIL_TUNE_ENABLED_KEY) === "true";
}

/** @param {boolean} enabled */
export function saveRecoilTuneEnabled(enabled) {
  if (typeof window === "undefined") return;
  localStorage.setItem(RECOIL_TUNE_ENABLED_KEY, String(enabled));
}
