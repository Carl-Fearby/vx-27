...
export function normalizeVx27ContainerDoorTuning(patch) {
  ...
  return {
    ...
    inframeFromEdge: clampNum(
      patch?.inframeFromEdge,
      L.inframeFromEdge.min,
      L.inframeFromEdge.max,
      d.inframeFromEdge
    ),
    thickness: clampNum(
      patch?.thickness,
...
export function exportVx27ContainerDoorTuningJson(tuning) {
  ...
  return {
    ...
    inframeFromEdge: parseFloat(t.inframeFromEdge.toFixed(4)),
