...
export const DEFAULT_OIL_BARREL_TUNING = {
  ...
  rimTileV: 3.3,
  interiorFire: true,
  interiorVideoWidthScale: 2,
  interiorVideoHeightScale: 2.6,
  interiorVideoCenterOffsetX: -0.155,
  interiorVideoCenterOffsetY: 0.185,
  /** Extra X for flame video + flicker light (stacks with video centre offset). */
  interiorFireOffsetX: 0.18,
  interiorFlameTexBottom: 0.15,
  interiorFlameTexTop: 0.92,
  interiorFireLightIntensity: 14,
  /** Shadow presence + edge softness — umbra stays fully dark (not a grey scale). */
  interiorFireShadowIntensity: 0.9,
