...
export const VERSION_HISTORY = [
  {
    ...
    date: "2026-06-08",
    commit: "8bec826",
    title: "Console hack minigame",
    changes: [
      "Work in progress: minigame where you hack the VX-27 control console (NODE BREACH UI, animated nodes, layout tuning).",
      "Outdoor rain and settling snow with separate intensity and stick sliders (5%–500%).",
    ],
  },
