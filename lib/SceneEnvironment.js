 ...
 * geometry (pass 1), then room interiors (pass 2) with VSMShadowMap so barrel fire
 * spot shadows get a heavily blurred penumbra (point lights only get 9-tap PCF).
 *
 * @param {THREE.WebGLRenderer} renderer
 * @param {THREE.Scene} scene
