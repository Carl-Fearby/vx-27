 ...
 * `roomId` is set so fire-light shadows and interior wall mats use room tuning.
...
function buildBarrelMesh(options = {}) {
  ...
  if (topCap) {
    ...
    // Half-width fire shadow footprint; exterior skips cast so the shell defines the penumbra.
