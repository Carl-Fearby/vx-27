...
/** Oil barrel interior video — unlit; drawn after world + room (see SceneEnvironment). */
export const BARREL_FLAME_LAYER = 5;

/** Camera mask for all gameplay render passes (world + viewmodel + room + health bars + sky + flame). */
 ...
 */
/** Interior fire / legacy flame meshes — not solid for bullets. */
...
export function setBarrelFlameLayer(object) {
  object.layers.set(BARREL_FLAME_LAYER);
}
