...
/** @param {{ tuning: import("@/lib/ui/HudBarTuning").HudBarTuning, onChange: (key: keyof import("@/lib/ui/HudBarTuning").HudBarTuning, value: number) => void, onReset: () => void, onClose?: () => void }} props */
