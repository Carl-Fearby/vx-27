...
import { renderSceneWithLayeredLighting } from "./SceneEnvironment.js";
import {
...
/** Load-screen GPU warmup off — avoids heavy first-frame recompile after finalize. */
...
export async function warmupGameGpu({
  ...
  for (const mesh of levelCollectibleMeshes) {
    ...
    await compileAndRender(renderer, scene, camera, scene, {
      frames: 4,
      renderFrame: layeredRender,
    });
