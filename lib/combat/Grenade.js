...
export function updateTrajectoryPreview(
  ...
  const { points, landPos, bouncePos } = simulateTrajectory(
    origin,
    vel,
    floorY,
    colliders,
  ...
  if (landPos) {
    ...
    _previewLandCircle.position.set(landPos.x, landPos.y + 0.02, landPos.z);
  ...
  if (bouncePos) {
    ...
    _previewBounceCircle.position.set(bouncePos.x, bouncePos.y + 0.02, bouncePos.z);
