...
export const MOON_SHADOW_MAP_SIZE = 1536;
...
export function moonElevationForNightness(elevationDeg, nightness) {
...
export function moonPositionForNightness(angles, nightness) {
  return sunPositionFromAngles(
    angles.azimuth,
    moonElevationForNightness(angles.elevation, nightness)
  );
}
