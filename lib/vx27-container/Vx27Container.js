...
function buildInteriorShell(width, height, length, shell, insets, edgeRadius = 0) {
  ...
  const beaconRig = createVx27ContainerBeaconRig(offsetX, ceilY, offsetZ);
  interior.add(beaconRig);
  interior.userData.vx27BeaconRig = beaconRig;
  interior.userData.vx27CeilingLight = beaconRig.userData.beaconSpot ?? null;
...
export { updateVx27ContainerBeaconLights } from "./Vx27ContainerBeaconLight.js";
