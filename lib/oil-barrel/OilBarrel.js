...
/**
 * Exterior + room barrels on WORLD (+ ROOM for shell). Flame on BARREL_FLAME only —
 * dedicated unlit pass after world + room so fire is not clipped by the metal shell.
