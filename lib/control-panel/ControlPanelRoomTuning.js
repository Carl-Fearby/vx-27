...
/**
 * VX-27 cargo module — room-pass ceiling point light; brighter than pillar-room crush.
 */
export const CONTROL_PANEL_CONTAINER_BRIGHTNESS_SCALE = 0.55;

export const CONTROL_PANEL_CONTAINER_HULL_COLOR_SCALE = 0.72;

export const CONTROL_PANEL_CONTAINER_HULL_EMISSIVE_SCALE = 0.32;
