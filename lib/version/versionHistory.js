...
export const VERSION_HISTORY = [
  {
    ...
    date: "2026-06-24",
    commit: "pending",
    title: "Credits enemy preview fixes",
    changes: [
      "Replace credits rifle GLB tiles with PX-27 android rig using in-game scaling and walk animation.",
      "Fix preview material dispose crash, lazy-load credits chunk, and tune camera zoom for showcase tiles.",
    ],
  },

  {
    ...
    date: "2026-06-24",
    commit: "1b73229",
    title: "Rifle crosshair polish and enemy rig showcase",
    changes: [
      "Rifle hip keeps the standard white cross; welded sight fades in on ADS — pistol always uses the standard crosshair.",
      "Bake crosshair tuning v24 hip defaults; lazy-load screen reticle mesh until rifle ADS.",
      "Marketing site — live PX-27 android rig preview, AI bad-guy tooling callout, and enemy pipeline specs.",
    ],
  },

  {
    ...
    date: "2026-06-23",
    commit: "a0dac74",
    title: "PX-27 combat androids and smarter enemy AI",
    changes: [
      "Meshy-skinned PX-27 android rigs with walk, run, and dual death clips — standard fall for head/torso, abdominal injury for leg hits, mixed staggered grenade deaths with blast knockback.",
      "Smarter rookie rifle AI — magazines, reload, cover, panic run, full-range fire, and distance-based damage.",
      "Outdoor lighting tuning, enemy rig depth fixes, level spawn updates, and marketing/credits refresh.",
    ],
  },

  {
    ...
    date: "2026-06-22",
    commit: "45955ff",
    title: "Rookie enemy AI and spawn fixes",
    changes: [
      "Armed targets patrol, reposition, and shoot using a recast navmesh (level1/2 AI tuning).",
      "Rifle pose + placeholder weapon mesh on alternating targets.",
      "Fix targets spawning or walking at catwalk height beside decks — arena floor wins under overhangs.",
      "Enemy foot Y snaps from ground support instead of lerping nav waypoint altitude.",
    ],
  },

  {
    ...
    date: "2026-06-20",
    commit: "e9acfbc",
    title: "Stair jump and HUD perf polish",
    changes: [
      "Allow jump on stairs when feet are on the ramp — stairSupported gate in game_core and PlayerController.",
      "Compass blips and collectible markers skip redundant DOM style writes each frame.",
      "Room culling toggles shell and sun occluders only when visibility state changes.",
      "Add GPU warmup helpers for laser tracers and bullet impacts (load-screen ready).",
    ],
  },

  {
    ...
    date: "2026-06-19",
    commit: "5651b09",
    title: "Spatial rain wetness with soft edges",
    changes: [
      "Floor reflectivity follows rain exposure — wet only where rain reaches, dry under catwalks, roofs, and interiors.",
      "Soft signed-distance fade and splatter noise at canopy edges instead of hard wet/dry lines.",
      "Skip wetness shader work when rain is off so normal gameplay FPS stays unaffected.",
    ],
  },

  {
    ...
    date: "2026-06-19",
    commit: "bff6501",
    title: "Storm lightning and rain polish",
    changes: [
      "Random single and double lightning flashes during rain — sky dome pulses brighter than the level with subtle ground bounce.",
      "Rain wetness, canopy muffling, thunderstorm ambient bed, and overcast atmosphere fixes.",
      "Remove in-game tuning panels and snow weather; tuning values still load from localStorage.",
      "Extend game_core WASM with weapon fire, collectibles, and ragdoll updates.",
    ],
  },

  {
    ...
    date: "2026-06-17",
    commit: "78d0798",
    title: "Aim recoil look-down fix",
    changes: [
      "Slide base pitch clamp with recoil so accumulated kick still feels natural but you can look back at the floor.",
    ],
  },

  {
    ...
    date: "2026-06-17",
    commit: "08a17ef",
    title: "RUSH physics migration & gameplay fixes",
    changes: [
      "game_core domain modules: player collision, headroom, ground support, VX-27 filters, ragdoll, target spawn, and reward-drop launch — lib.rs split into focused Rust files.",
      "gameCore.ts wires all WASM exports; live gameplay paths require Rust via requireWasm (no silent JS fallbacks).",
      "Fix five-target spawn fill, container health bar visibility, and ragdoll toppleTime regression after the migration.",
      "hack_core grid puzzle logic compiled; NODE BREACH UI still bridges from JavaScript.",
    ],
  },

  {
    ...
    date: "2026-06-17",
    commit: "803aebb",
    title: "RUSH combat rules in Rust",
    changes: [
      "Extend game_core WASM: ammo, throwables, combat score, target damage/repair, grenade blast, kill drops, death/respawn, and wall shop.",
      "JS game loop delegates hot-path rules to Rust via gameCore.ts; Three.js keeps rendering, raycasts, and VFX.",
      "hack_core grid puzzle scaffold compiled; NODE BREACH UI still on JS until wired.",
      "Marketing site documents RUSH split: JavaScript shows, Rust computes.",
    ],
  },

  {
    ...
    date: "2026-06-17",
    commit: "7fdd15b",
    title: "Game over splash & combat polish",
    changes: [
      "GAME OVER when lives run out — restart returns to Start Game without preloader; load screen blocks combat and fire audio.",
      "ADS +30% damage and −40% recoil; wall shops grant one mag per purchase.",
      "Hack loot: random pistol or rifle mag, ammo pool sync, auto-reload on empty mag.",
    ],
  },

  {
    ...
    date: "2026-06-17",
    commit: "d178527",
    title: "NODE BREACH retries & RUSH migration",
    changes: [
      "NODE BREACH: five retries, random loot table, harder security auto-aim, pointer-lock exit fix.",
      "Ammo defaults: three mags pistol/rifle; hack grants spare mags.",
      "RUSH: migrate hot-path logic to Rust/WASM — game_core live, hack_core scaffolding.",
    ],
  },

  {
    ...
    date: "2026-06-16",
    commit: "4560177",
    title: "Dev tuning session fixes and HUD perf",
    changes: [
      "Dev tune panels no longer reopen from localStorage on load; side effects gated while a panel is open.",
      "Walk power HUD caches DOM refs and skips redundant style writes each frame.",
      "Drop knife prototype viewmodel code to retry melee with a fresh approach.",
    ],
  },

  {
    ...
    date: "2026-06-12",
    commit: "e38c9f5",
    title: "Version history sync and redeploy",
    changes: [
      "Sync git commit history metadata to current HEAD for accurate /version stats.",
      "Redeploy live static export at v0.1.53.",
    ],
  },

  {
    ...
    date: "2026-06-12",
    commit: "456b669",
    title: "Cinematic lasers, ADS tuning, and shop fixes",
    changes: [
      "Cinematic dual-layer laser bolts — short glowing muzzle pulse with weapon tracking.",
      "Tighter ADS zoom and slower aim-move strafe for hold-to-aim.",
      "Rifle shop denied buzz when short on credits; purchase crosshair in the buy ring.",
      "Hip idle weapon breathe after 2s still; grenade throws release from the view-weapon hand.",
      "Wall purchase holster/draw equip; marketing and SEO refreshed for rifle shop and grenades.",
    ],
  },
