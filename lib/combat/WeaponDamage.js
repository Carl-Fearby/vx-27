...
/** Max raycast / effective hit distance for rifle-class fire (player + enemies). */
export const BULLET_MAX_RANGE = 55;
...
/**
 * Rifle body-shot damage at range — shared by player hip-fire and enemy rifle fire.
 * @param {number} shotDistance metres from muzzle to target
 * @param {GameCoreEngine} gameCore
 */
export function resolveRifleBodyDamageAtDistance(shotDistance, gameCore) {
  return resolveBodyZoneDamage(
    WEAPON_DAMAGE_PROFILES.rifle,
    "body",
    1,
    shotDistance,
