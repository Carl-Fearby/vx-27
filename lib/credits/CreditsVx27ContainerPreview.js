...
export async function mountCreditsVx27ContainerPreview(
  ...
  // Static tilt on an inner group; Y spin on spinRoot so the camera pivot
  // stays at the module center (tilt after fitObjectUniform offsets the bbox).
  tiltRoot.rotation.set(0.04, -0.48, 0.02);
